package com.terra.framework.geyser.monitor;
...
public class CacheMonitorService {
    ...
    public CacheMonitorService(CacheUtils cacheUtils, CacheProperties properties) {
    ...
    public void logCacheStats() {
        ...
        for (Map.Entry<String, String> entry : statsMap.entrySet()) {
            ...
            if (hitRate != null && hitRate < properties.getHitRateWarningThreshold()) {
                log.warn("缓存[{}]命中率较低({}%), 低于警告阈值({}%)", 
                        cacheName, hitRate, properties.getHitRateWarningThreshold());
            }
        }
    ...
    public CacheHealthInfo getCacheHealth(String cacheName) {
        ...
        healthInfo.setHealthy(hitRate != null && hitRate >= properties.getHitRateWarningThreshold());
