...
import com.terra.framework.crust.handler.ResponseAdvice;
import com.terra.framework.crust.handler.RestExceptionHandler;
...
public class TerraWebAutoConfiguration {
    ...
    @ConditionalOnProperty(prefix = "terra.web.exception-handler", name = "enabled", havingValue = "true", matchIfMissing = true)
    public RestExceptionHandler terraRestExceptionHandler() {
