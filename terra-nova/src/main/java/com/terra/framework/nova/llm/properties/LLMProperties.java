...
public class LLMProperties {
    ...
    public static class BaiduConfig {
         ...
         * API端点
         */
        private String apiEndpoint = "https://aip.baidubce.com/rpc/2.0/ai_custom/v1/wenxinworkshop/chat";
    ...
    public static class SparkConfig {
         ...
         * API端点
         */
        private String apiEndpoint = "wss://spark-api.xf-yun.com/v3.5/chat";
