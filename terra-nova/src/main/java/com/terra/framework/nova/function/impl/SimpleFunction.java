...
public class SimpleFunction implements Function {
     ...
     */
    public SimpleFunction(String name, String description, List<Parameter> parameters, Schema responseSchema) {
    ...
    public static class Builder {
        ...
        public SimpleFunction build() {
            return new SimpleFunction(name, description, parameters, responseSchema);
        }
    }
} 